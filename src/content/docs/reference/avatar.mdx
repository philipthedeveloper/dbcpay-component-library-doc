...
Read more about [Avatar](https://www.radix-ui.com/docs/primitives/components/avatar) here.
...
<Tabs>
  <TabItem label="CLI">
    ```bash
    npx shadcn@latest add https://baseUrl/avatar.json
    ```
  </TabItem>
...
```tsx
import {Avatar, AvatarWithStatusIcon} from "@/register/ui/avatar/Avatar"
```
